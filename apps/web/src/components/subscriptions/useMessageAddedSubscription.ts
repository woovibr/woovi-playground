...
const useMessageAddedSubscription = (variables: MessageAddedSubscription$variables) => {
  const newMessageConfig = useMemo<GraphQLSubscriptionConfig<MessageAddedSubscription>>(
    () => ({
